...
/// Phrase-only recovery for zcashd emergency recovery phrases: legacy
/// Sapling and transparent derivation with no `wallet.dat`.
pub mod zcashd_phrase;
...
pub use zcashd_phrase::{
    GapLimits, ZcashdPhraseKeySource, ZcashdSeedKind, DEFAULT_GAP_LIMIT, PHRASE_CANNOT_RECOVER,
